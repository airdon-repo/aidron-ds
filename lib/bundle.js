...
const Check = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("label", {
    ...
    disabled: disabled,
    hidden: true,
    readOnly: true // onChange={(e) => handleChange(e.target.value)}
    ,
    value: checkedValue,
...
const DataList = ({
  ...
  const PropedComponent = (comp, args) => {
    if ( /*#__PURE__*/React__default['default'].isValidElement(comp)) {
      return /*#__PURE__*/React__default['default'].cloneElement(comp, { ...args
      });
    }
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: "content"
  }, page.map(item => PropedComponent( /*#__PURE__*/React__default['default'].createElement(ItemComponent, null), { ...itemProps,
    ...item.original
...
const THIS_YEAR = +new Date().getFullYear(); // 1 => January, 12 => December
...
const CALENDAR_WEEKS = 6; // Adds leading zeroes until length is reached
// zeroPad(5, 2) => '05'

const zeroPad = (value, length) => `${value}`.padStart(length, '0'); // (int) Number days in a month for a given year from 28 - 31
...
const Calendar = (month = THIS_MONTH, year = THIS_YEAR) => {
  ...
  const monthFirstDay = getMonthFirstDay(month, year); // Total of 42 days (6 weeks by default) to bedisplayed on the calendar
...
const DatePicker = ({
  ...
  const monthYearController = () => {
    const monthname = locale$1.localize.month(Math.max(0, Math.min(month - 1, 11)));
    return /*#__PURE__*/React__default['default'].createElement("div", {
...
const Progress = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(StyledProgress // role="progressbar"
  , {
    "data-testid": "progress",
    style: !circular ? {
      width
...
const Select = ({
  ...
  }, [selected]); // eslint-disable-next-line consistent-return
