...
const DataList = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: ["aidron", "datalist"].join(" "),
    "data-testid": "datalist"
  }, /*#__PURE__*/React__default["default"].createElement("div", {
    className: "content"
  }, page.map((item, index) => PropedComponent( /*#__PURE__*/React__default["default"].createElement(ItemComponent, null), {
    ...itemProps,
    ...item.original,
    key: index
...
DataList.propTypes = {
   ...
   */
  recordCount: PropTypes__default["default"].number.isRequired,
  /**
   * Sorting options
   */
 ...
 */
var b$2=60103,c$1=60106,d$1=60107,e$1=60108,f$1=60114,g$2=60109,h$1=60110,k$2=60112,l$1=60113,m$2=60120,n$1=60115,p$1=60116,q$2=60121,r$1=60122,u=60117,v$2=60129,w$2=60131;
if("function"===typeof Symbol&&Symbol.for){var x$2=Symbol.for;b$2=x$2("react.element");c$1=x$2("react.portal");d$1=x$2("react.fragment");e$1=x$2("react.strict_mode");f$1=x$2("react.profiler");g$2=x$2("react.provider");h$1=x$2("react.context");k$2=x$2("react.forward_ref");l$1=x$2("react.suspense");m$2=x$2("react.suspense_list");n$1=x$2("react.memo");p$1=x$2("react.lazy");q$2=x$2("react.block");r$1=x$2("react.server.block");u=x$2("react.fundamental");v$2=x$2("react.debug_trace_mode");w$2=x$2("react.legacy_hidden");}
function y$2(a){if("object"===typeof a&&null!==a){var t=a.$$typeof;switch(t){case b$2:switch(a=a.type,a){case d$1:case f$1:case e$1:case l$1:case m$2:return a;default:switch(a=a&&a.$$typeof,a){case h$1:case k$2:case p$1:case n$1:case g$2:return a;default:return t}}case c$1:return t}}}var z$2=g$2,A$2=b$2,B$1=k$2,C$1=d$1,D$1=p$1,E$1=n$1,F$1=c$1,G$1=f$1,H$1=e$1,I=l$1;var ContextConsumer$1=h$1;var ContextProvider$1=z$2;var Element$1=A$2;var ForwardRef$1=B$1;var Fragment$1=C$1;var Lazy$1=D$1;var Memo$1=E$1;var Portal$1=F$1;var Profiler$1=G$1;var StrictMode$1=H$1;
var Suspense$1=I;var isAsyncMode$1=function(){return !1};var isConcurrentMode$1=function(){return !1};var isContextConsumer$1=function(a){return y$2(a)===h$1};var isContextProvider$1=function(a){return y$2(a)===g$2};var isElement$1=function(a){return "object"===typeof a&&null!==a&&a.$$typeof===b$2};var isForwardRef$1=function(a){return y$2(a)===k$2};var isFragment$1=function(a){return y$2(a)===d$1};var isLazy$1=function(a){return y$2(a)===p$1};var isMemo$1=function(a){return y$2(a)===n$1};
var isPortal$1=function(a){return y$2(a)===c$1};var isProfiler$1=function(a){return y$2(a)===f$1};var isStrictMode$1=function(a){return y$2(a)===e$1};var isSuspense$1=function(a){return y$2(a)===l$1};var isValidElementType$1=function(a){return "string"===typeof a||"function"===typeof a||a===d$1||a===f$1||a===v$2||a===e$1||a===l$1||a===m$2||a===w$2||"object"===typeof a&&null!==a&&(a.$$typeof===p$1||a.$$typeof===n$1||a.$$typeof===g$2||a.$$typeof===h$1||a.$$typeof===k$2||a.$$typeof===u||a.$$typeof===q$2||a[0]===r$1)?!0:!1};
var typeOf$1=y$2;
...
function z$1(a){if("object"===typeof a&&null!==a){var u=a.$$typeof;switch(u){case c:switch(a=a.type,a){case l:case m$1:case e:case g$1:case f:case p:return a;default:switch(a=a&&a.$$typeof,a){case k$1:case n:case t:case r:case h:return a;default:return u}}case d:return u}}}function A$1(a){return z$1(a)===m$1}var AsyncMode=l;var ConcurrentMode=m$1;var ContextConsumer=k$1;var ContextProvider=h;var Element=c;var ForwardRef=n;var Fragment=e;var Lazy=t;var Memo=r;var Portal=d;
...
var isValidElementType=function(a){return "string"===typeof a||"function"===typeof a||a===e||a===m$1||a===g$1||a===f||a===p||a===q$1||"object"===typeof a&&null!==a&&(a.$$typeof===t||a.$$typeof===r||a.$$typeof===h||a.$$typeof===k$1||a.$$typeof===n||a.$$typeof===w$1||a.$$typeof===x$1||a.$$typeof===y$1||a.$$typeof===v$1)};var typeOf=z$1;
...
Dropdown.propTypes = {
   ...
   * Open/Close handler
   */
  setOpen: PropTypes__default["default"].bool,
  /**
...
`;
const linearProgressFeedback = $e`
  0% {
    left: -200%;
    right: 100%;
  }
...
const Select = ({
  ...
  const [selectedText, setSelectedText] = React.useState(label);
  ...
  const handleSingle = value => setSelectedItem(value === selectedItem ? undefined : value);
  ...
  React.useEffect(() => {
    if (children) {
      setRichChildren(children.map((child, idx) => {
        if ( /*#__PURE__*/React__default["default"].isValidElement(child) && child.type === SelectItem) {
          return /*#__PURE__*/React__default["default"].cloneElement(child, {
            key: idx.toString(),
            onSelect: multiselect ? handleMultiple : handleSingle,
  ...
  React.useEffect(() => {
    if (!multiselect) {
      ...
      if (children && selectedItem) {
        const first = children === null || children === void 0 ? void 0 : children.find(child => child.props.value === selectedItem);
        setSelectedText(`${label} ${selectedItem && first ? first.props.children : undefined}`);
      }
      if (!selectedItem) setSelectedText(label);
    }
  }, [selectedItem]);
  React.useEffect(() => {
    if (!multiselect) setSelectedItem(selected);else setMultiSelected(selected);
  }, [selected]);
